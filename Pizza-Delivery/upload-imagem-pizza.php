...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $conexao->prepare("INSERT INTO felipe_img_pizza (imagem_pizza, nome_imagem, caminho_imagem) VALUES (?, ?, ?)");

        $stmt->bindValue(1, $pizza->setIdSabor($_SESSION["id_user"]));
...
<html>
    ...
    <body>
        ...
        <br>
        <a href="/projeto01/EntregaOK/crud-pizza.php">Voltar</a>
    </body>
</html>
